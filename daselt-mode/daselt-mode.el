...
;; `pkg-configs/daselt/daselt-ext.del'.
...
(defun daselt-mode--pkg-configs-directory-enter-manually ()
  ...
  (let* ((use-file-dialog nil) ; Dialog box doesn't let you select folder (or I was doing something wrong).
         (filename (read-file-name "Please point daselt-mode to its pkg-configs directory (in the directory where daselt-mode is installed, include trailing backslash): "
                                   nil nil
