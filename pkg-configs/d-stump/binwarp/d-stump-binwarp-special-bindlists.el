;;; d-stump-binwarp-special-bindlists.el --- Binwarp bindlists for the d-stump init.  -*- lexical-binding: t; -*-
...
;; This file contains the keylists for maps of d-stump. If daselt-d-stump is t, it is parsed automatically when daselt-mode is started. Each element in this file should be either
...
;;;;;;; H-1 
;;;;;;;; H-1-0 
  (("H-" . (1 0 1)) . "exit-binwarp"))

;;; d-stump-binwarp-special-bindlists.el ends here
