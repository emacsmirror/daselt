;;; d-emacs-tabulated-list-bindlists.el --- d-emacs-maps for tabulated-list  -*- lexical-binding: t; -*-
...
;; This file contains the keylists for maps of tabulated-list. If d-tabulated-list is t, it is parsed automatically when d-emacs-mode is started. Each element in this file should be either
...
;;;;;;;; 1-0
  ((1 0 -3) . #'previous-line) 
  ((1 0 -2) . #'tabulated-list-previous-column) 
  ((1 0 2) . #'tabulated-list-next-column) 
  ((1 0 3) . #'next-line) 
