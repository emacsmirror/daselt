...
;;;;;;; C-4 
;;;;;;;; C-4--1 
  (("C-" . (4 -1 -5)) . #'icicle-insert-key-description) 
  (("C-" . (4 -1 -1)) . #'icicle-apropos-complete-and-narrow) 
  (("C-" . (4 -1 2)) . #'icicle-apropos-complete-and-exit) 
  (("C-" . (4 -1 4)) . #'d-emacs-icicle-avy-jump) 

;;;;;;;; C-4-0 
  (("C-" . (4 0 -5)) . #'icicle-help-on-candidate) 
  (("C-" . (4 0 -2)) . #'icicle-roundup) 
  (("C-" . (4 0 -1)) . #'icicle-narrow-candidates) 
  (("C-" . (4 0 1)) . #'icicle-widen-candidates) 

;;;;;;;; C-4-1 
  (("C-" . (4 1 -4)) . #'icicle-candidate-set-swap) 
  (("C-" . (4 1 4)) . #'icicle-insert-list-join-string) 

;;;;;;; C-7 
;;;;;;;; C-7--1 
  (("C-" . (7 -1 -4)) . #'icicle-keep-only-past-inputs) 
  (("C-" . (7 -1 2)) . #'icicle-candidate-read-fn-invoke) 
  (("C-" . (7 -1 5)) . #'icicle-candidate-set-save-selected) 

;;;;;;;; C-7-0 
  (("C-" . (7 0 -5)) . #'icicle-candidate-set-retrieve) 
  (("C-" . (7 0 3)) . #'icicle-retrieve-next-input) 
  (("C-" . (7 0 4)) . #'icicle-save/unsave-candidate) 
  (("C-" . (7 0 5)) . #'icicle-candidate-set-save) 

;;;;;;;; C-7-1 
  (("C-" . (7 1 -5)) . #'icicle-candidate-set-retrieve-from-variable) 
  (("C-" . (7 1 5)) . #'icicle-candidate-set-save-to-variable) 

;;;;;; H- 
;;;;;;; H-4 
;;;;;;;; H-4--1 
  (("H-" . (4 -1 -3)) . #'d-emacs-icicle-previous-S-TAB-completion-method) 
  (("H-" . (4 -1 -2)) . #'icicle-candidate-set-intersection) 
  (("H-" . (4 -1 2)) . #'icicle-candidate-set-union) 
  (("H-" . (4 -1 3)) . #'icicle-next-S-TAB-completion-method) 

;;;;;;;; H-4-0 
  (("H-" . (4 0 -3)) . #'d-emacs-icicle-previous-completion-style-set) 
  (("H-" . (4 0 -2)) . #'icicle-candidate-set-complement) 
  (("H-" . (4 0 2)) . #'icicle-candidate-set-difference) 
  (("H-" . (4 0 3)) . #'icicle-next-completion-style-set) 

;;;;;;;; H-4-1 
  (("H-" . (4 1 -3)) . #'d-emacs-icicle-previous-TAB-completion-method) 
  (("H-" . (4 1 3)) . #'icicle-next-TAB-completion-method) 

;;;;;;; H-7 
;;;;;;;; H-7--1 
  (("H-" . (7 -1 -3)) . #'d-emacs-icicle-backward-cycle-incremental-completion) 
  (("H-" . (7 -1 3)) . #'icicle-cycle-incremental-completion) 

;;;;;;;; H-7-0 
  (("H-" . (7 0 -4)) . #'d-emacs-icicle-previous-sort-order) 
  (("H-" . (7 0 -1)) . #'icicle-scroll-Completions-backward) 
  (("H-" . (7 0 1)) . #'icicle-scroll-Completions-forward) 
  (("H-" . (7 0 4)) . #'icicle-change-sort-order) 

;;;;;;;; H-7-1 
  (("H-" . (7 1 -3)) . #'d-emacs-icicle-backward-cycle-expand-to-common-match) 
  (("H-" . (7 1 3)) . #'icicle-cycle-expand-to-common-match) 

;;;;;; H-C- 
;;;;;;; H-C-4 
;;;;;;;; H-C-4--1 
  (("H-C-" . (4 -1 -3)) . #'icicle-delete-candidate-object) 

;;;;;; M- 
;;;;;;; M-4 
;;;;;;;; M-4--1 
  (("M-" . (4 -1 4)) . #'icicle-history) 

;;;;;;;; M-4-0 
  (("M-" . (4 0 3)) . #'icicle-dispatch-M-comma) 

;;;;;;; M-7 
;;;;;;;; M-7-0 
  (("M-" . (7 0 -1)) . #'icicle-candidate-set-truncate) 

;;;;;; M-C- 
;;;;;;; M-C-4 
;;;;;;;; M-C-4--1 
  (("M-C-" . (4 -1 -4)) . #'icicle-display-candidates-in-Completions) 
  (("M-C-" . (4 -1 -2)) . #'icicle-recomplete-from-original-domain) 
  (("M-C-" . (4 -1 4)) . #'d-emacs-icicle-avy-insert) 

;;;;;;; M-C-7 
;;;;;;;; M-C-7--1 
  (("M-C-" . (7 -1 5)) . #'icicle-candidate-set-save-more-selected) 

;;;;;;;; M-C-7-0 
  (("M-C-" . (7 0 -5)) . #'icicle-candidate-set-retrieve-more) 
  (("M-C-" . (7 0 5)) . #'icicle-candidate-set-save-more) 

;;;;;; M-H- 
;;;;;;; M-H-4 
;;;;;;;; M-H-4-0 
  (("M-H-" . (4 0 -5)) . #'bmkp-retrieve-icicle-search-hits) 
  (("M-H-" . (4 0 -4)) . #'icicle-doremi-increment-swank-timeout+) 
  (("M-H-" . (4 0 -3)) . #'icicle-doremi-increment-variable+) 
  (("M-H-" . (4 0 -2)) . #'icicle-doremi-candidate-width-factor+) 
  (("M-H-" . (4 0 2)) . #'icicle-doremi-zoom-Completions+) 
  (("M-H-" . (4 0 3)) . #'icicle-doremi-increment-max-candidates+) 
  (("M-H-" . (4 0 4)) . #'icicle-doremi-inter-candidates-min-spaces+) 
  (("M-H-" . (4 0 5)) . #'bmkp-set-icicle-search-hits-bookmark) 

;;;;;;;; M-H-4-1 
  (("M-H-" . (4 1 0)) . #'icicle-doremi-increment-swank-prefix-length+) 

;;;;;; s- 
;;;;;;; s-4 
;;;;;;;; s-4--1 
  (("s-" . (4 -1 -3)) . #'icicle-remove-candidate) 
  (("s-" . (4 -1 -1)) . #'icicle-narrow-candidates-with-predicate) 
  (("s-" . (4 -1 1)) . #'icicle-apropos-complete-and-widen) 
  (("s-" . (4 -1 4)) . #'icicle-other-history) 

;;;;;;;; s-4-0 
  (("s-" . (4 0 -2)) . #'icicle-all-candidates-action) 

;;;;;;;; s-4-1 
  (("s-" . (4 1 -2)) . #'icicle-all-candidates-list-action) 

;;;;;;; s-7 
;;;;;;;; s-7-0 
  (("s-" . (7 0 -4)) . #'icicle-regexp-quote-input) 
  (("s-" . (7 0 -3)) . #'icicle-retrieve-last-input) 
  (("s-" . (7 0 4)) . #'icicle-plus-saved-sort) 

;;;;;;;; s-7-1 
  (("s-" . (7 1 5)) . #'icicle-save-predicate-to-variable) 

;;;;;; s-C- 
;;;;;;; s-C-4 
;;;;;;;; s-C-4--1 
  (("s-C-" . (4 -1 3)) . #'d-emacs-icicle-insert-anychar-regexp) 
  (("s-C-" . (4 -1 4)) . #'icicle-switch-to-Completions-buf) 

;;;;;;;; s-C-4-0 
  (("s-C-" . (4 0 -2)) . #'icicle-candidate-set-define) 

;;;;;;; s-C-7 
;;;;;;;; s-C-7-0 
  (("s-C-" . (7 0 -5)) . #'icicle-candidate-set-retrieve-persistent) 
  (("s-C-" . (7 0 -3)) . #'icicle-retrieve-previous-input) 
  (("s-C-" . (7 0 5)) . #'icicle-candidate-set-save-persistently) 

;;;;;; s-H- 
;;;;;;; s-H-4 
;;;;;;;; s-H-4-0 
  (("s-H-" . (4 0 -2)) . #'icicle-all-candidates-alt-action) 
  (("s-H-" . (4 0 2)) . #'icicle-candidate-alt-action) 

;;;;;;;; s-H-4-1 
  (("s-H-" . (4 1 -2)) . #'icicle-all-candidates-list-alt-action))
...
;;;;;;;; C-4-0
  (("C-" . (4 0 -5)) . #'icicle-help-on-candidate) 
  (("C-" . (4 0 -3)) . #'icicle-move-to-previous-completion) 
  (("C-" . (4 0 2)) . #'icicle-insert-completion) 
  (("C-" . (4 0 3)) . #'icicle-move-to-next-completion) 
...
;;;;;;;; C-7-0 
  (("C-" . (7 0 -5)) . #'icicle-candidate-set-retrieve) 
  (("C-" . (7 0 -3)) . #'icicle-retrieve-previous-input) 
  (("C-" . (7 0 5)) . #'icicle-candidate-set-save) 
