;;; d-emacs-xref-bindlists.el --- d-emacs-xref-bindlists for d-emacs  -*- lexical-binding: t; -*-
...
;; This file contains the keylists for xref maps of d-emacs. If daselt-d-emacs is t, it is parsed automatically when daselt-mode is started. Each element in this file should be either
