;;; d-emacs-gnus-bindlists.el --- d-emacs-bindlists for gnus  -*- lexical-binding: t; -*-
...
;; This file contains the keylists for maps of gnus. If d-gnus is t, it is parsed automatically when d-emacs-mode is started. Each element in this file should be either
...
;;;;;;; 7 
;;;;;;;; 7-0 
  ((7 0 2) . #'d-emacs-gnus-group-select-group-t))
...
;;;;;;; 5
;;;;;;;; 5-0
  ((5 0 -2) . #'gnus-summary-exit) 
  ((5 0 2) . #'gnus-summary-next-page))

;;; d-emacs-gnus-bindlists.el ends here
