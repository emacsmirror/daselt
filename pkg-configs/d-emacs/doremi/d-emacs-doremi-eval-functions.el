;;; d-emacs-doremi-eval-functions.el --- d-emacs-functions for doremi-functions  -*- lexical-binding: t; -*-
...
(provide 'd-emacs-doremi-eval-functions)
;;; d-emacs-doremi-eval-functions.el ends here
