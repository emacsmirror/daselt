;;; d-emacs-help-bindlists.el --- d-emacs-bindlists for help  -*- lexical-binding: t; -*-
...
;; This file contains the keylists for maps of help. If d-help is t, it is parsed automatically when d-emacs-mode is started. Each element in this file should be either
...
;;;;;;;; 2-0 
  ((2 0 -2) . #'help-go-back) 
  ((2 0 2) . #'help-go-forward))

;;; d-emacs-help-bindlists.el ends here
