;;; d-emacs-yasnippet-bindlists.el --- d-emacs-bindlists for yasnippet  -*- lexical-binding: t; -*-
...
;; This file contains the keylists for maps of yasnippet. If d-yasnippet is t, it is parsed automatically when d-emacs-mode is started. Each element in this file should be either
