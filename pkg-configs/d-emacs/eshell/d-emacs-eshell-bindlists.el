;;; d-emacs-eshell-bindlists.el --- d-emacs-bindlists for eshell  -*- lexical-binding: t; -*-
...
;; This file contains the keylists for maps of eshell. If d-eshell is t, it is parsed automatically when d-emacs-mode is started. Each element in this file should be either
