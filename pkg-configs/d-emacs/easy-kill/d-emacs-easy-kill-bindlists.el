;;; d-emacs-easy-kill-bindlists.el --- d-emacs-bindlists for easy-kill  -*- lexical-binding: t; -*-
...
;; This file contains the keylists for maps of easy-kill. If d-easy-kill is t, it is parsed automatically when d-emacs-mode is started. Each element in this file should be either
...
;;;;;;; 1
;;;;;;;; 1--1
  ((1 -1 -2) . #'easy-kill-mark-region) 

;;;;;;;; 1-1 
  ((1 1 -4) . #'easy-kill-append) 
