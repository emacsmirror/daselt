;;; d-emacs-cdlatex.el -- d-emacs-commands for cdlatex  -*- lexical-binding: t; -*-
...
(defun d-emacs-cdlatex-math-symbol ()
...
text-expressions, with ARG, it uses math expressions."
  ...
  (defun d-emacs-cdlatex-math-modify-modeline-math ()
...
(provide 'd-emacs-cdlatex)
;;; d-emacs-cdlatex.el ends here
