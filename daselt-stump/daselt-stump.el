...
`daselt-stump/pkg-configs/' \(without its path) and a symbol representing a
...
(defun daselt-stump--pkg-configs-directory-enter-manually ()
  ...
  (let* ((use-file-dialog nil) ; Dialog box doesn't let you select folder (or I was doing something wrong).
         (filename (read-file-name "Please point daselt-stump to its pkg-configs directory (in the directory where daselt-stump is installed, include trailing backslash): "
                                   nil nil
